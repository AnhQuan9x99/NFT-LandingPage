...
import { faUser, faStarHalfAlt, faDownload, faGem } from "@fortawesome/free-solid-svg-icons";
type Props = {
    ...
    return (
        <section id="counter" className="section hero-wrap">
            ...
            <div className="hero-bg parallax" style={{
                backgroundImage: 'url("/images/home-page/intro-bg-4.ipg")',
            ...
            <div className="hero-content">
                <div className="container">
                    ...
                    <div className="col-6 col-md-3">
                            <div className="featured-npx text-center">
                        ...
                        <div className="col-6 col-md-3">
                            <div className="featured-npx text-center">
                                ...
                                <h4 className="text-11 text-white fw-500"><span className="counter" data-from={0} data-to={58}>120</span>K</h4>
