            ...
            <div className="row g-0">
                <div className="col-md-6 col-lg-7">
                    <div className="section px-4 px-sm-5 mx-lg-5">
                        ...
                        <p className="lead text-center mb-5">We will get back to you in less than 24 hours.</p>
                        <form id="contact-form" action="" method="post">
                            <div className="mb-3">
                                <input name="name" type="text" className="form-control border-2" placeholder="Name" required />
                            </div>
                            <div className="mb-3">
                                <input name="email" type="text" className="form-control border-2" placeholder="Email" required />
                            </div>
                            <div className="mb-3">
                                <textarea name="form-message" className="form-control border-2" rows={3} placeholder="Message ......"
                ...
                <div className="col-md-6 col-lg-5 bg-light">
                    <section className="section px-4 px-sm-5 mx-lg-4">
                        ...
                        <p className="lead">
                            For Customer Suppoer and Query, Get in touch with us.
                        </p>
