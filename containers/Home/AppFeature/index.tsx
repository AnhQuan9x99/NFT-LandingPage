...
import { faPencilRuler, faCloudDownloadAlt, faTags, faLock, faPaperPlane, faSyncAlt } from "@fortawesome/free-solid-svg-icons";

type Props = {

}
const AppFeature: React.FC<Props> = () => {
    return (
        <section id="features" className="section">
            <div className="container">
                ...
                <p className="lead text-center mb-5">You can present your app features. It iss all very easy</p>
                <div className="row">
                    <div className="col-lg-4 align-self-center">
                        ...
                        <div className="col-md-6 col-lg-12">
                            <div className="featured-box fearured-box-reverse-xl style-3 mb-5">
                                <div className="featured-box-icon bg-light-1 rounded-circle">
                                    <FontAwesomeIcon icon={faCloudDownloadAlt} />
                                </div>
                                <h3>Your Date in Cloud</h3>
                                <p>Lisque persius interesset his et, in quot quidam persequeris vim, ad mea essent possim iriure</p>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-12">
